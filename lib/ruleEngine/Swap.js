...
class FormatSwap {
  ...
  perform(txDetail) {
    ...
    for (let swapEvent of swapEvents) {
      ...
      if (incomingTokenAddress && incomingTokenAddress.toUpperCase() == "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2".toUpperCase()){
        incomingTokenAddress = "Ether";
      }

      if (outgoingTokenAddress && outgoingTokenAddress.toUpperCase() == "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2".toUpperCase()){
      ...
      return oThis.checkIfEqual(txDetail.highlightedEventTexts, swapSummarry, "Swap");
    }
