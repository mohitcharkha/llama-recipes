...
class DbMigrate {
  ...
  async _runMigration(version) {
    ...
    console.log('Executed migration version(', version, ')');
    console.log('-----------------------------------------');
  }
  ...
  async _revertMigration(version) {
    ...
    console.log('-----------------------------------------');
    console.log('Reverting migration version(', version, ')');
    ...
    console.log('Reverted migration version(', version, ')');
    console.log('-----------------------------------------');
  }
  ...
  async _executeQuery(versionInfo, query) {
    ...
    console.log('Executing on db: ', dbName);
